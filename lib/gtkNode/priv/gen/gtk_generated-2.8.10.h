...
/*******************************/
gboolean Gtk_tool_button_get_icon_name(int ARI, ei_x_buff *XBUF, char *B, int *I){
  ...
  R = gtk_tool_button_get_icon_name(object);
  gn_put_string(XBUF,(char*)R);
  return TRUE;
}
/*******************************/
...
/*******************************/
gboolean Gtk_tool_button_set_icon_name(int ARI, ei_x_buff *XBUF, char *B, int *I){
...
/*******************************/
gboolean Gtk_tree_view_column_queue_resize(int ARI, ei_x_buff *XBUF, char *B, int *I){
...
/*******************************/
gboolean Gtk_window_get_urgency_hint(int ARI, ei_x_buff *XBUF, char *B, int *I){
  ...
  if ( ! gn_check_arity(XBUF, 1, ARI) ) return FALSE;
  if ( ! gn_get_arg_object(XBUF, B, I, GTK_TYPE_WINDOW, (GObject**)&object) ) return FALSE;
  R = gtk_window_get_urgency_hint(object);
  gn_put_boolean(XBUF,(int)R);
  return TRUE;
}
/*******************************/
...
/*******************************/
gboolean Gtk_window_present_with_time(int ARI, ei_x_buff *XBUF, char *B, int *I){
...
/*******************************/
gboolean Gtk_window_set_urgency_hint(int ARI, ei_x_buff *XBUF, char *B, int *I){
