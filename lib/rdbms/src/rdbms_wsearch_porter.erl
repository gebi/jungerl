...
%%%----------------------------------------------------------------------
%%%-------------------------------------------------------------------
%%% File    : rdbms_wsearch_porter.erl
%%% Author  : Hans Nilsson <hans.r.nilsson@ericsson.com>
%%% Purpose : Porter Stemming 
%%% Created : 16 Nov 2004 by Hans Nilsson <hans.r.nilsson@ericsson.com>
%%%
%%%-------------------------------------------------------------------
-module(rdbms_wsearch_porter).
-author('hans.r.nilsson@ericsson.com').
...
-export([stem/1,				% The main function
	 tst/0					% for testing
	]).
